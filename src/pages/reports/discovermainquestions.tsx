...
const DiscoverMainQuestionsReportPage= () => {
  ...
  const fetchData = async () => {
    const mainquestionprops = await getReportProps(ReportType.DISCOVER_MAIN_QUESTIONS);
    Promise.resolve(mainquestionprops);
    console.log('MainQuestionprops  :', mainquestionprops);
    setData(mainquestionprops);
    setLoading(false);
  };
  useMountEvents({
    onMounted: async () => {
...
export default DiscoverMainQuestionsReportPage;
