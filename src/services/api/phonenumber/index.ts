...
const MODEL = OwnerModelType.PHONENUMBER;
...
export const createOrUpdate = (ownerParams: OwnerParams,
                       data: PhoneNumberItem): AxiosPromise<unknown> => {
 ...
 * @param data
 */
export const update = (ownerParams: OwnerParams, data: PhoneNumberItem): AxiosPromise<unknown> =>
  request.private({
    method: 'put',
    url: buildOwnerUrl(ownerParams),
    data
 ...
 * @param id
 */
export const remove = (ownerParams: OwnerParams, data: PhoneNumberItem): AxiosPromise<unknown> =>
  request.private({
    method: 'delete',
    url: buildOwnerUrl(ownerParams),
    data
