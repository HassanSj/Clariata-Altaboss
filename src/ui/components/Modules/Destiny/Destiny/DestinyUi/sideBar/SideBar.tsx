...
import React, { FC, ReactElement, ReactFragment, ReactNode, useState } from "react";
...
// const SideBar: FC<props> = ({ planExist }): ReactElement => {
//     const classes = useStyles();
//     const [showCreateButtton, setShowCreateButtton] = useState<boolean>(planExist)
...
//                 <div>
//                     {showCreateButtton ? null : <button className="create_plan_button">Create Plan</button>}
//                 </div>
//                 <Box >
