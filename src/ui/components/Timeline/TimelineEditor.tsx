...
import { Button as MuiButton, FormControlLabel, Checkbox, Grid, Button, Icon, Divider } from '@material-ui/core';
...
import TimelineReport, { CustomFilter, getTimelineData, Timeline, TimelineFilters } from './TimelineReport';
...
const TimelineEditor = ({ isOpen, onClose, showFilter }: IProps): ReactElement => {
