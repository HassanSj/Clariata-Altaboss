...
import SignInHistoryItem from "~/ui/components/User/SignInHistoryItem/SignInHistoryItem";

const SignInHistory = (): ReactElement => {
    ...
    const loadData = async () => {
        try {
            ...
            processServerError(err, 'SignInHistory.loadData');
        }
    }
            ...
            <Card>
                ...
                <CardContent>
                    <DataWrapper isGrouped={false}
                                 paginator={paginator}
                                 propLabel="item"
                                 keyLabel="SignInHistoryItem"
                                 component={SignInHistoryItem} />
                </CardContent>
            </Card>
        </>
    )
